...
# 📖  Leaerboard: plain HTML with CSS <a name="about-project"></a>

**Leaerboard** is a basic website I use HTML, CSS, and Webpack .
...
```sh
 cd my-folder
 git clone git@github.com:AliShahSafdari/Leaderboard.git
```
### Install
...
Everybody is welcome to suggest changes in Leaderboard project .
